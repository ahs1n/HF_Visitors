...
public class EntryLog extends BaseObservable implements Observable {
    ...
    public void populateMeta() {
        ...
        setUuid(MainApp.dpr.getUid());  // not applicable in Form table
        setUserName(MainApp.user.getUserName());
        setSysDate(MainApp.dpr.getSysDate());
...
//        setPsuCode(MainApp.form.getPsuCode());
        setiStatus(MainApp.dpr.getiStatus());
        setiStatus96x(MainApp.dpr.getiStatus96x());
