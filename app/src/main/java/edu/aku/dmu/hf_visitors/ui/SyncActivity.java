package edu.aku.dmu.hf_visitors.ui;

import static edu.aku.dmu.hf_visitors.core.MainApp.PROJECT_NAME;
import static edu.aku.dmu.hf_visitors.core.MainApp.sdDir;
import static edu.aku.dmu.hf_visitors.core.MainApp.uploadData;
...
import edu.aku.dmu.hf_visitors.contracts.TableContracts.NFamilyMaxTable;
...
import edu.aku.dmu.hf_visitors.models.SyncModel;
import edu.aku.dmu.hf_visitors.workers.DataDownWorkerALL;
import edu.aku.dmu.hf_visitors.workers.DataUpWorkerALL;
import edu.aku.dmu.hf_visitors.workers.PhotoUploadWorker2;
        ...
        switch (view.getId()) {
            ...
            case R.id.btnSync:
                ...
                if (sync_flag) {
                    ...
                    select = " * ";
                    filter = " hf_code = '" + MainApp.user.getHfcode() + "' ";
                    downloadTables.add(new SyncModel(ListingMembersTable.TABLE_NAME, select, filter));

                    downloadTables.add(new SyncModel(VisitsCountTable.TABLE_NAME, select, filter));
                    ...
                    // NFamilyMax Table
                    downloadTables.add(new SyncModel(NFamilyMaxTable.TABLE_NAME, select, ""));
                }
