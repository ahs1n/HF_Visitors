...
import static edu.aku.dmu.hf_visitors.core.MainApp.TAJIKISTAN;
import static edu.aku.dmu.hf_visitors.database.DatabaseHelper.DATABASE_COPY;
...
import edu.aku.dmu.hf_visitors.core.AppInfo;
import edu.aku.dmu.hf_visitors.core.MainApp;
import edu.aku.dmu.hf_visitors.database.DatabaseHelper;
import edu.aku.dmu.hf_visitors.databinding.ActivityLoginBinding;
 ...
 /*            countryCode = getCountryCode(this);
    ...
    public void onSyncDataClick(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            startActivity(new Intent(this, edu.aku.dmu.hf_visitors.ui.SyncActivity.class).putExtra("login", true));
        } else {
    ...
    public void attemptLogin(View view) {
        ...
        if (attemptCounter == 7) {
            Intent iLogin = new Intent(edu.aku.dmu.hf_visitors.ui.LoginActivity.this, MainActivity.class);
